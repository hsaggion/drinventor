 ...
 *
 */
public class RelativePositionOfFirstMatchOfWordsInListC implements FeatCalculator<Double, Annotation, DocumentCtx> {
	 ...
	 */
	public RelativePositionOfFirstMatchOfWordsInListC(Set<String> listOfWordsToMathc,
