 ...
 *
 */
public class RelativePositionOfFirstMatchOfAnnotationC implements FeatCalculator<Double, Annotation, DocumentCtx> {
	 ...
	 */
	public RelativePositionOfFirstMatchOfAnnotationC(
				...
				if(!foundFisrstOccurrence && annotInt != null) {
					...
					if(!foundFisrstOccurrence &&
						...
						if(sentenceLength > 0d) {
							returnValue = round( ( internalAnnotationMiddleOffset / sentenceLength ), 4) * 100d;
